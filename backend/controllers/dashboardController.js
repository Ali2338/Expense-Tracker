...
const { recompileSchema } = require('../models/Income');
...
exports.getDashboardData = async (req, res) => {
    try {
        ...
        //Get income transaction in last 30 days
        ...
        const incomeLast30Days = last30DaysIncomeTransactions.reduce((sum, transaction) => {
            sum + transaction.amount, 0;
        })
